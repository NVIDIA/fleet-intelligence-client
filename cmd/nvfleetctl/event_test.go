...
func TestEventListTableAbsolute(t *testing.T) {
	...
	got := out.String()
	// Every event JSON field should be represented as a column/value.
	for _, want := range []string{
		"EVENT ID", "NODE UUID", "COMPONENT", "NAME", "TYPE", "MESSAGE", "TIMESTAMP", "CREATED AT", "SUGGESTED ACTIONS",
		"e1", "node-1", "GPU", "xid", "boom", "2026-05-01T00:00:00Z", "2026-05-01T00:00:05Z", "reboot node (R1)",
		"Total Entries: 1",
	} {
